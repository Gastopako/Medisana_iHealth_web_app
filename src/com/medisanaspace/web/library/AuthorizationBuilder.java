...
public final class AuthorizationBuilder {
	...
	public static final int ACTIVITYDOCK_MODULE_ID = 6;
	public static final int TRACKER_STATS_ID = 7;
	public static final int TRACKER_ACTIVITY_ID = 8;
	public static final int TRACKER_SLEEP_ID = 9;
	
	private static final String[] MODULE_NAME = {"cardiodocks", "glucodockglucoses", "glucodockinsulins", "glucodockmeals",
			"targetscales", "thermodocks", "activitydocks", "tracker/stats", "tracker/activity", "tracker/sleep"};
	...
	public static String createUnauthorizedAccessRequestAuthorizationHeader(
		...
		signatureMap.put(SignatureHelper.OAUTH_CONSUMER_KEY_STRING,	applicationToken);
		signatureMap.put(SignatureHelper.OAUTH_SIGNATURE_METHOD_STRING,	SignatureHelper.SIGNATURE_METHOD);
		...
		signatureMap.put(SignatureHelper.OAUTH_VERSION_STRING, SignatureHelper.VERSION);

		final String baseParameterString = MapUtil.createBaseParameterString(signatureMap, null);

		final String baseSignatureString = SignatureHelper
				.calculateBaseSignatureString(POST_STRING, requestUrl, baseParameterString);

		final String signature = SignatureHelper.calculateSignature(baseSignatureString, applicationSecret, null);
	...
	public static String createAccessRequestAuthorizationHeader(
		...
		signatureMap.put(SignatureHelper.OAUTH_TOKEN_STRING, unauthorizedAccessToken);
		signatureMap.put(SignatureHelper.OAUTH_VERIFIER_TOKEN_STRING, verifierToken);
		
		signatureMap.put(SignatureHelper.OAUTH_VERSION_STRING, SignatureHelper.VERSION);

		String baseParameterString = MapUtil.createBaseParameterString(signatureMap, null);

		String baseSignatureString = SignatureHelper.calculateBaseSignatureString(POST_STRING, requestUrl, baseParameterString);

		String signature = SignatureHelper.calculateSignature(baseSignatureString, applicationSecret, unauthorizedAccessSecret);
	...
	public static String createInvalidateaccesssRequestAuthorizationHeader(
					final String applicationToken, final String applicationSecret,
					final String AccessToken,
					final String AccessSecret)
					throws Exception {

				String requestUrl = VitaDockServer.HTTPS_AUTH_URL + "/accesses/logout";
				String timestamp = Long.toString(new Date().getTime());
				String nonce = RandomStringUtils.randomAlphanumeric(NONCE_LENGTH);
				...
				String signature = SignatureHelper.calculateSignature(baseSignatureString, applicationSecret, AccessSecret);
